...
const all = document.getElementById("filter-all-btn");
const cse = document.getElementById("filter-cse-btn");
const wdd = document.getElementById("filter-wdd-btn");
...
cse.addEventListener('click', function(event) {
    event.preventDefault();
    document.querySelector("#course-list").innerHTML = "";
    createCourseCard(courses.filter(course => course.subject == "CSE"));
})

wdd.addEventListener('click', function(event) {
    event.preventDefault();
    document.querySelector("#course-list").innerHTML = "";
